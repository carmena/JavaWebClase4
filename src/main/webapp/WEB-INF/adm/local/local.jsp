    ...
    <body>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9">
                    <div class="row">
                        <a class=" btn btn-primary pull-right" href="<%=contextPath%>/local?action=<%=Constants.ACTION_CREATE%>"> Nuevo </a>
                        <h1> Locales </h1>
                    </div>
                                ...
                                <td> 
                                    <div class="btn-group">
                                        ...
                                        <ul class="dropdown-menu pull-right">
                                            <li>
                                                <a href="<%=contextPath%>/local?action=<%=Constants.ACTION_UPDATE%>&id=<%=local.getId()%>">
                                                Editar<a>
                                            </li>
                                            <li>
                                                <a href="<%=contextPath%>/local?action=<%=Constants.ACTION_DELETE%>&id=<%=local.getId()%>">
                                                    Eliminar<a>
                                            </li>
                                        </ul>
                                      </div>
