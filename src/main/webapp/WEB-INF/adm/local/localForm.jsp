...
<html lang="en">
    <head>
        <meta charset="utf-8">
        <title> Locales - Nuevo Local </title>
        ...
        <div class="container-fluid">
            <div class="row-fluid">
                ...
                <div class="span9">
                    ...
                    <form action="<%=contextPath%>/local" method="post">
                        
                        <input hidden="id" value="${local.id}" name="id">
                        ...
                        <div class="control-group">
                            <div class="controls">
                                <a class="btn" href="<%=contextPath%>/local">Cancelar</a>
